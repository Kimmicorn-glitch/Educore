...
export const FirebaseProvider: React.FC<FirebaseProviderProps> = ({
  ...
  const contextValue = useMemo((): FirebaseContextState => {
    ...
    const isSupportAgent = !!userAuthState.claims?.isSupportAgent;
    return {
...
export const useFirebase = (): FirebaseServicesAndUser => {
  ...
  return {
    ...
    isSupportAgent: context.isSupportAgent,
  };
};
...
export const useUser = (): UserHookResult => { // Renamed from useAuthUser
  const { user, isUserLoading, userError, isSupportAgent } = useFirebase(); // Leverages the main hook
  return { user, isUserLoading, userError, isSupportAgent };
};
